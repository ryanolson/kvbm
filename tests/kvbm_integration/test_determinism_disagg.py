...
class LLMServerManager:
    ...
    def __init__(
        ...
        self.env.update(
            {
                "RUST_BACKTRACE": "1",
                # KvbmConnector connection settings (from runtime_services fixture env)
            }
        )
    ...
    def _set_up_vllm_config(self, gpu_cache_blocks):
        ...
        self.prefiller_cmd = [
            ...
            "8000",  # required to fit on L4 GPU when using 8b model
            "--kv-transfer-config",
            '{"kv_connector":"PdConnector","kv_role":"kv_both","kv_connector_extra_config":{"connectors":[{"kv_connector":"KvbmConnector","kv_connector_module_path":"kvbm.vllm.connector","kv_role":"kv_both"},{"kv_connector":"NixlConnector","kv_role":"kv_both"}]},"kv_connector_module_path":"kvbm.vllm.connector"}',
        ]
