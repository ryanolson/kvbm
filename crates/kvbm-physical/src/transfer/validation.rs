...
pub enum BlockValidationError {
    ...
    // Constructed only by the debug_assertions-gated disjoint check; compiled out of release builds.
    ...
    // Constructed only by the debug_assertions-gated range check; compiled out of release builds.
    #[cfg_attr(not(debug_assertions), allow(dead_code))]
    ...
    // Constructed only by validate_bounce_unique, reached only on the debug_assertions path; compiled out of release builds.
    #[cfg_attr(not(debug_assertions), allow(dead_code))]
...
// Called only from the debug_assertions path of validate_block_transfer; unused in release builds.
#[cfg_attr(not(debug_assertions), allow(dead_code))]
...
// Called only from validate_disjoint_same_layout (debug_assertions-gated); unused in release builds.
#[cfg_attr(not(debug_assertions), allow(dead_code))]
