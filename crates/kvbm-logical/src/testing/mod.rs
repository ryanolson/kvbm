...
//! Shared test fixtures for logical module tests.
//!
...
//!
//! Note: the testing module uses only the public API and remains separate.
...
/// Primary test metadata type used across logical tests.
